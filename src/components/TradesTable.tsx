...
const TradesTable: React.FC<TradesTableProps> = ({
  ...
  return (
    <div className="p-4 bg-white">
          ...
          <div className="sticky top-0 z-10 bg-white">
            ...
            <div className="flex bg-gray-100 border-b border-gray-300">
              <div className="h-8 px-2 text-xs font-medium text-gray-700 border-r border-gray-300 flex items-center justify-center bg-gray-100"
                ...
                <input
                  type="checkbox"
                  checked={selectedTrades.size === currentPageTrades.length && currentPageTrades.length > 0}
      ...
      {/* Pagination Controls (moved outside the bordered, overflow-hidden container so always visible) */}
